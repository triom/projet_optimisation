_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 1.3055,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1.0084,
    profiled_time = 53.88,
    array_access_efficiency = 93.75,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.0084,
    nb_threads = 1,
    application_time = 53.919357299805,
    compilation_options = 49.15,
    innerloops_time = 30.92,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 16.66 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 16.66 seconds.",
  },
  colors = {
