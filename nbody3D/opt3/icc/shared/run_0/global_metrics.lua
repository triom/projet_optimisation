_report = {
  metrics = {
    ...
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 2.9254405675902,
    speedup_if_perfect_MPI_OMP_PTHREAD = 2.0379050336254,
    ...
    speedup_if_fully_vectorised = 1.0054,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1.0096,
    profiled_time = 1.07,
    array_access_efficiency = 99.907063197026,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.0098,
    nb_threads = 8,
    application_time = 1.2405849695206,
    compilation_options = 25,
    innerloops_time = 34.97,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 0.37 seconds.",
