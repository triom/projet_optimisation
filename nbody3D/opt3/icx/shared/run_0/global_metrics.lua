_report = {
  metrics = {
    ...
    compilation_flags = "nbody3DCX: \n",
    speedup_if_perfect_openmp = "Not Available",
    __name = "run_0",
    nb_loops_80_if_L1 = "Not Available",
    loops_time = 45.74,
    speedup_if_fp_vect = 1.1455,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 2.1564868134201,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.9843945968656,
    ...
    speedup_if_fully_vectorised = 1.2783,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1.0004,
    profiled_time = 1.28,
    array_access_efficiency = 40.122066754117,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.2645,
    nb_threads = 8,
    application_time = 1.3209660053253,
    compilation_options = 25.11,
    innerloops_time = 45.74,
  },
  help = {
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 0.59 seconds.",
  },
  colors = {
  ...
  comp_opt_report = {
    ["nbody3DCX#nbody.c"] = {
      opts = " --intel -x host -Ofast -fsave-optimization-record nbody.c -o nbody3DCX -qmkl=parallel -fiopenmp -fveclib=SVML -fheinous-gnu-extensions",
      score = "0.75",
