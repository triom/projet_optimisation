_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 1.2884,
    ...
    nb_threads = 1,
    application_time = 76.810455322266,
    compilation_options = 49.16,
    innerloops_time = 29.58,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 22.47 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 22.47 seconds.",
  },
  colors = {
