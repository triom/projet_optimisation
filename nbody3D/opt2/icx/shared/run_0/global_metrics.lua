_report = {
  metrics = {
    ...
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.1206440514471,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0334849111203,
    ...
    speedup_if_clean = 1,
    profiled_time = 1.23,
    array_access_efficiency = 33.333333333333,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1,
    nb_threads = 8,
    application_time = 1.3933980464935,
    compilation_options = 25,
    innerloops_time = 95.96,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 1.18 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 1.18 seconds.",
  },
  colors = {
