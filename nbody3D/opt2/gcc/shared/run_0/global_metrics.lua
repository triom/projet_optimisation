_report = {
  metrics = {
    ...
    loops_time = 20.77,
    speedup_if_fp_vect = 1.0484,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.0040415033921,
    ...
    speedup_if_fully_vectorised = 1.1845,
    ...
    nb_threads = 8,
    application_time = 15.665363311768,
    compilation_options = 49.92,
    innerloops_time = 20.77,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 3.20 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 3.20 seconds.",
  },
  colors = {
