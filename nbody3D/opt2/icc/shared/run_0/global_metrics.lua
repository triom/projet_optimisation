_report = {
  metrics = {
    ...
    loops_time = 90.82,
    speedup_if_fp_vect = 1.0006,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.2142808401926,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0645092612306,
  ...
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 1.04 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 1.04 seconds.",
  },
  colors = {
