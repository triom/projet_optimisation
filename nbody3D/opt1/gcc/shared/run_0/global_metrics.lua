_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 1.6183,
    ...
    nb_threads = 1,
    application_time = 39.267562866211,
    compilation_options = 49.78,
    innerloops_time = 50.94,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 19.99 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 19.99 seconds.",
  },
  colors = {
